...
const variants = {
  primary:   'bg-[var(--navy-800)] text-white hover:bg-[var(--navy-900)] shadow-sm',
  ...
  warm:      'bg-[var(--amber-500)] text-white hover:opacity-90 shadow-sm',
  outline:   'border border-[var(--navy-800)] text-[var(--navy-800)] hover:bg-[var(--accent-soft)]',
}
